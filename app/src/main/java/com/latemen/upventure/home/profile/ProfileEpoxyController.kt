...
import com.latemen.upventure.databinding.EpoxyModelProfileSignedInItemBinding
import com.latemen.upventure.databinding.EpoxyModelProfileSignedOutBinding
...
class ProfileEpoxyController(
    ...
    override fun buildModels(data: ApplicationState.AuthState) {
        ...
        if (data is ApplicationState.AuthState.Authenticated) {
            ...
            SignedInItemEpoxyModel(
                iconRes = R.drawable.round_logout_24,
                headerText = "Logout",
                infoText = "Sign out of your account",
                onClick = { profileUiActions.onProfileItemSelected(R.drawable.round_logout_24) }
            ).id(R.drawable.round_logout_24).addTo(this)
        }
    }
